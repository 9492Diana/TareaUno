<?php 
	...
	$selectJoin = "SELECT * FROM estudiantes 
			INNER JOIN nota_estudiante ON estudiantes.id_estudiante = nota_estudiante.id_estudiante
			INNER JOIN nota             ON nota.id_notas             = nota_estudiante.id_notas
			INNER JOIN materia          ON materia.id_materia        = nota_estudiante.id_materia WHERE materia.id_materia=$id_materia AND estudiantes.id_estudiante=$id_estudiante";
